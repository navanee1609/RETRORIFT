        ...
        <div className='footer-content text-white d-grid container'>
          <div className='footer-item'>
            <a href="#" className='navbar-brand text-white text-uppercase no-wrap d-block'>
              Retro <span>Rift</span>
            </a>
            <p className='para-text'>


🎮 Welcome to RetroRift - Your Gateway to Gaming Nostalgia!

Discover the joy of gaming at Retrotift, where nostalgia meets innovation. Immerse yourself in a world of classic and modern games, connect with fellow gamers, and level up your gaming experience. Join the Retrotift community and game on!</p>
          </div>
      ...
      <div className='footer-bottom'>
        <div className='container d-flex flex-column text-center'>
          <p className='footer-bottom-text text-green'>Copyright &copy; RetroRift - All rights reserved.</p>
